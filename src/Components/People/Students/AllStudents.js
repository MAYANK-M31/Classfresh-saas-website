...
import AllStudentsTable from "../TableView/AllStudentsTable";
  ...
  return (
    ...
    >
      ...
      <div className="Main-Inside-Div">
        ...
        >
          <AllStudentsTable key={RenderList} />
        </div>
                ...
                <Chip
                  ...
                  label={
                    item.section == undefined
                      ? `${item.class.label.toUpperCase()}`
                      : `${item.class.label.toUpperCase()}-${item.section.label.toUpperCase()}`
                  }
                  clickable
                  variant="outlined"
                  color="primary"
